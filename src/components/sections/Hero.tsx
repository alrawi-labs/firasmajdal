...
const sideVariants = (rtl: boolean): Variants => ({
  ...
  visible: { opacity: 1, x: 0, transition: { duration: 1, ease: EASE_OUT } },
});
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          {/* Next.js Image: fill için position:relative + explicit boyut şart */}
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <motion.div
            ...
            animate="visible"
          >
            <motion.p variants={itemVariants} className="text-primary font-bold tracking-[0.35em] uppercase text-sm mb-6">
              {t("badge")}
            </motion.p>
            <motion.h1 variants={titleVariants} className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-8">
            ...
            <motion.p variants={itemVariants} className="text-white/80 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed font-light">
              {t("desc")}
            </motion.p>
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground h-14 px-8 text-base tracking-widest uppercase rounded-none border-none cursor-pointer transition-shadow duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.35)]">
                  {t("cta1")}
                </Button>
              </motion.a>
              <motion.a
                ...
                transition={{ type: "spring", stiffness: 400, damping: 20 }}
              >
                <Button size="lg" variant="outline" className="h-14 px-8 text-base tracking-widest uppercase rounded-none text-white border-white/30 hover:bg-white/10 hover:text-white cursor-pointer transition-all duration-300 hover:border-white/60">
                  {t("cta2")}
                </Button>
              </motion.a>
            </motion.div>

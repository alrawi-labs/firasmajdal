  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p
          className="text-[#888] hidden sm:block"
  ...
  <div className="flex md:hidden justify-around py-4 border-t border-black/10 mt-4">
    {stats.map((s, i) => (
      <div key={i} className="flex flex-col items-center gap-0.5">
        <p className="text-[#1a1a1a] font-bold" style={{ fontSize: "1.4rem" }}>
          {s.value}
        </p>
        <p
          className="text-[#888] tracking-widest uppercase text-center"
          style={{ fontSize: "9px" }}
        >
          {s.label}
        </p>
        ...
        >
          ...
          >
            <div className="p-6 md:p-8">
              <p
                className="text-[#B8975A] tracking-[0.28em] uppercase mb-3"
                style={{ fontSize: "clamp(10px,1vw,12px)" }}
              >
                Gayrimenkul Danışmanlığı
              </p>
              <h1
                className="text-[#1a1a1a] leading-[1.05] mb-4"
              ...
              <div
                className="mb-4"
                style={{ width: "36px", height: "2px", background: "#B8975A" }}
              />
              <p
              ...
              >
                Lüks konut ve ticari gayrimenkul yatırımlarınızda değerleme,
                portföy yönetimi ve satın alma süreçlerinde profesyonel
                rehberlik.
              </p>
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      padding: "clamp(11px,1.4vh,15px) clamp(18px,2.2vw,30px)",
                    }}
                  >
                    İletişime Geç
                    <svg
                ...
                <a
                 href={getWhatsAppLink(
                    "Merhaba, gayrimenkul ilanlarınızı görmek istiyorum.",
                  )}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button
                    className="flex items-center gap-2 border text-[#1a1a1a] hover:border-[#B8975A] hover:text-[#B8975A] transition-colors duration-300 tracking-[0.18em] uppercase cursor-pointer"
                    style={{
                      fontSize: "clamp(10px,1vw,12px)",
                      padding: "clamp(11px,1.4vh,15px) clamp(18px,2.2vw,30px)",
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, #F5F2ED 0%, #F0EDE8 2%, transparent 28%)",
                  }}
                />
              </div>
            </motion.div>
        ...
        >
          {stats.map((s, i) => (
            ...
            >
              ...
              <div className="flex flex-col items-center">
                ...
                <p
                  className="text-[#888] tracking-[0.18em] uppercase text-center"
                  style={{ fontSize: "10px" }}
                >
                  {s.label}
                </p>
          ...
          >
            ...
            <p
              ...
              style={{ fontSize: "13px" }}
            >
              Hayalinizdeki mülkü birlikte buluyoruz.
            </p>
            <p className="text-[#888]" style={{ fontSize: "11px" }}>
              Portföyümüzü keşfetmek için iletişime geçin.
            </p>
          </div>
        </motion.div>
      </div>

...
const services = [
  {
    ...
    description: "Gayrimenkul alım-satım, kiralama ve diğer işlemlerinizde hukuki destek sağlıyoruz.",
  },
  {
    id: "02",
    icon: (
    ...
    description: "Yurt içi ve yurt dışı yatırımlarınız için hukuki danışmanlık hizmetleri sunuyoruz.",
  },
  {
    id: "03",
    icon: (
    ...
    title: "İkamet İzni İşlemleri",
    description: "Oturma izni süreçlerinizde profesyonel destek ile işlemlerinizin takibini gerçekleştiriyoruz.",
  },
  {
    id: "04",
    icon: (
    ...
    description: "Şirket kuruluşu, sözleşmeler ve ticari uyuşmazlıklarda yanınızda oluyoruz.",
  },
];
  ...
  return (
    <>
      <style>{`
        ...
        /* Mobilde alt border, desktop'ta sağ border */
        .svc-card-wrap {
          border-bottom: 1px solid rgba(201,168,76,0.12);
        }
        .svc-card-wrap:last-child {
          border-bottom: none;
        }
        @media (min-width: 640px) {
          .svc-card-wrap {
          ...
          /* 2 sütunda: sağ sütundaki kartların sağ border'ını kaldır */
      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          ...
          <div style={{
            ...
            background: "linear-gradient(to bottom, rgba(10,12,18,0.85) 0%, rgba(10,12,18,0.78) 50%, rgba(10,12,18,0.90) 100%)",
          }} />
          <div style={{
            position: "absolute", inset: 0,
            backgroundImage: `
          ...
          <div style={{
            position: "absolute", inset: 0,
            background: "radial-gradient(ellipse 85% 70% at 50% 50%, transparent 20%, rgba(10,12,18,0.6) 100%)",
          }} />
        </div>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            Size Özel{" "}
            <em style={{ fontStyle: "italic", color: "#C9A84C" }}>Çözümler</em>
          </motion.h2>
          ...
          >
            {services.map((svc, i) => (
              <div key={svc.id} className="svc-card-wrap">
                <motion.div
                  className="svc-card"
